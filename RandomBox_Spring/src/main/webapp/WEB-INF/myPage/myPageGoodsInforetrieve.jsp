...
<form name="myform">
	gCode : <input type="text" name="gCode" value="${dto.gCode }"
		readonly="readonly"><br> gCategory : <input type="text"
		name="gCategory" value="${dto.gCategory }"><br> gName :
	<input type="text" name="gName" value="${dto.gName }"><br>
	gPrice : <input type="text" name="gPrice" value="${dto.gPrice }"><br>

	gImage : <input type="file" name="gImage" value="${dto.gImage }"><br>
	gContentImage : <input type="file" name="gContentImage"
		value="${dto.gContentImage }"><br> gAmount : <input
		type="text" name="gAmount" value="${dto.gAmount }"><br>
